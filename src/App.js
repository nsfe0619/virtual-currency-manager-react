      ...
      <HashRouter>
        <nav className="px-5 flex items-center h-[60px] bg-indigo-500 text-white">
          ...
          <ul className="flex">
            ...
            <li>
              <Link to="/FirstPage" className="border p-3 hover:bg-indigo-600 duration-500">FirstPage</Link>
            </li>
            <li>
              <Link to="/SecondPage" className="border p-3 hover:bg-indigo-600 duration-500">SecondPage</Link>
            </li>
          </ul>
        </nav>
        <Routes>
